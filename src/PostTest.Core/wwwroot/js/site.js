...
var baseUrl = "http://localhost:51359/";
...
function searchRender() {
    $.ajax({
        url: baseUrl + "Home/ParcelSearch",   //'@Url.Action("ParcelSearch", "Home")',
...
function register() {
    $.ajax({
        url: baseUrl + "Home/ParcelRegister",  // '@Url.Action("ParcelRegister", "Home")',
        data: getFormJson(),
        type: 'POST',
